...
<header>
    ...
    <?php endwhile; // end of the loop. ?>
          ...
          <footer>
            <section id="social">
              <ul>
                <li class="col-xs-4 col-md-4"><a href="http://www.facebook.it"><img src="wp-content/themes/understrap/img/facebook.png"></a></li>
                <li class="col-xs-4 col-md-4"><a href="http://www.behance.com"><img src="wp-content/themes/understrap/img/behance.png"></a></li>
                <li class="col-xs-4 col-md-4"><a href="https://telegram.me/EdoardoLiotta"><img src="wp-content/themes/understrap/img/telegram.png"></a></li>
              </ul>
            </section>
          </footer>
